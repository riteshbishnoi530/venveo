        ...
        <div className="max-w-[1440px] mx-auto relative z-10">
            <nav className="flex justify-between lg:items-start items-center pl-14 max-lg:px-4">
                ...
                <div className="flex absolute right-0">
                    <div
                        className={`flex gap-[42px] lg:pl-10 lg:pr-7 max-lg:fixed max-lg:left-0 max-lg:h-full max-lg:w-full max-lg:flex-col lg:bg-white lg:py-7 max-lg:bg-gray-800 max-lg:duration-300 max-lg:justify-center max-lg:items-center z-10 max-lg:text-white ${open ? 'max-lg:top-0' : 'max-lg:top-full'}`}
                    >
                        ...
                        <form action="" className="w-full flex justify-between items-center lg:hidden bg-platinum py-6 px-2.5">

...
function Hero() {
  return (
    <div className='mb-64 max-md:mb-20'>
      <div className='md:bg-off-green'>
        <div className='relative md:max-h-[869px] max-w-[1920px] max-md:bg-hero-image-small bg-top bg-[length:100%_75%] bg-no-repeat mx-auto'>

                  ...
                  <div>
                      {LEARN_LIST.map((obj, i) => (
                          <div className='max-w-[320px]' key={i}>
                              <h4 className='text-custom-sm font-semibold leading-[20px] text-off-green uppercase font-maisonLight'>{obj.heading}</h4>
                              <h3 className='text-black font-light text-3xl leading-[30px] max-w-[325px] pt-4 font-maisonLight'>{obj.subHeading}</h3>
                              <h3 className='text-black font-light text-3xl leading-[30px] max-w-[325px] font-maisonLight'>{obj.subHeadingTwo}</h3>
                              <p className='text-black font-normal text-custom-sm leading-5 max-w-[315px] pt-4 space-mono'>{obj.description}</p>
                              <button className='bg-transparent text-custom-sm font-semibold text-black mt-[28px] font-maisonBold flex gap-2 hover:gap-4 transition-all ease-linear duration-200 items-center justify-center'>{obj.btn}<BtnArrow/></button>
                          </div>
                      ))}
                  </div>
                  </div>
